...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_boards_user_order", "boards", ["owner_id", "position"], unique=False
    )
    op.create_table(
        "refreshtokens",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_tables_board_position", "tables", ["board_id", "position"], unique=False
    )
    op.create_table(
        "rows",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_rows_table_position", "rows", ["table_id", "position"], unique=False
    )
    op.create_table(
        "notes",
        sa.Column("id", sa.UUID(), nullable=False),
