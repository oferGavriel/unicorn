  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        default: 'bg-background shadow-sm hover:bg-accent text-accent-foreground',
        destructive:
          'bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90',
        clean: 'text-destructive-foreground rounded-none',

        outline:
          'bg-background shadow-sm hover:text-accent-foreground border border-gray-500 hover:bg-accent',
        secondary: 'bg-secondary text-white shadow-sm hover:bg-secondary/90',
        ghost: 'hover:bg-[#353537b3] hover:text-accent-foreground',
